                        ...
                        "components": [
                            {
                                ...
                                "style": 5,
                                "url": getattr(before.channel, "jump_url", "https://discord.com/app"),
                                "disabled": not bool(before.channel),
                            },
                            {
                                "type": 2,
                                "label": "Join channel after",
                                "style": 5,
                                "url": getattr(after.channel, "jump_url", "https://discord.com/app"),
                                "disabled": not bool(after.channel),
                            },
                        ],
                    }
                ],
